...
const thinBase = (size = 18) => ({
  ...base(size),
  strokeWidth: 1.7,
});

/** A quieter play symbol for contextual actions such as channel and artist headers. */
export const PlayOutlineIcon = ({ size, className }: IconProps) => (
  <svg {...thinBase(size)} className={className}>
    <path d="M8 5.5 17.2 12 8 18.5Z" />
  </svg>
);

/** Matches PlayOutlineIcon so the header action does not turn into a filled control while playing. */
export const PauseOutlineIcon = ({ size, className }: IconProps) => (
  <svg {...thinBase(size)} className={className}>
    <path d="M9 6.25v11.5M15 6.25v11.5" />
  </svg>
);
...
export const SidebarTracksIcon = ({ size, className }: IconProps) => (
  <svg {...base(size)} className={className}>
    <rect x="3.5" y="3.5" width="17" height="17" rx="4" />
    <path d="M14.5 8v7" />
    <path d="M14.5 8l4-1v3l-4 1" />
    <circle cx="11.8" cy="16.2" r="2.2" fill="currentColor" stroke="none" />
  </svg>
);

export const SidebarChannelIcon = ({ size, className }: IconProps) => (
  <svg {...base(size)} className={className}>
...
export const SidebarPlaylistIcon = ({ size, className }: IconProps) => (
  <svg {...base(size)} className={className}>
    <path d="M4 6h11" />
    <path d="M4 11h8" />
    <path d="M4 16h6" />
    <path d="m14 13 6 3.5-6 3.5Z" fill="currentColor" stroke="none" />
  </svg>
);

export const SidebarArtistIcon = ({ size, className }: IconProps) => (
  <svg {...base(size)} className={className}>
