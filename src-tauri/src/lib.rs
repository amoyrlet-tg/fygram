...
use features::lyrics::commands as lyrics_commands;
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cache_commands::get_cache_max_age,
            cache_commands::set_cache_max_age,
            ...
            storage_commands::use_downloads_media_root,
            sync_commands::get_sync_status,
            sync_commands::sync_now,
            track_commands::list_tracks,
            track_commands::download_track,
            track_commands::download_tracks,
